...
const ShippingAddress = (props) => {
    ...
    const onSubmit = (data) => {
        ...
        //     })
        //     .catch((error) => {
        //         message.error("Item added to your wishlist.")
        //     });
    };
        ...
        <div>
            <Card className="card-shadow">
                <div className="row">
                    ...
                    {!isAuthenticated && (
                        <div className="col-md-6">
                            <i onClick={() => dispatch(setGuest())} class="fas fa-edit f-right pointer"></i>
                        </div>
                    )}
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Card className="mt-20 card-shadow">
                    ...
                    <div className="btn-flex-end">
                        <div className=" btn-rows pb-3 pt-3 place-butun">
                            <button className="hovr-style" type="submit" >{loading && <i className="fas fa-spinner fa-pulse"></i>} Payment</button>
                            {/*<button className="hovr-style" onClick={()=>props.shippingClick()} type="button" >{loading && <i className="fas fa-spinner fa-pulse"></i>} Payment</button>*/}
                        </div>
                    </div>
                </Card>
            </form>
