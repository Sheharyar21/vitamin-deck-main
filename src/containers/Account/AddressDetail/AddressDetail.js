...
function AddressDetails(props) {
    ...
    return <Content>
            ...
            <button onClick={()=>handleVisible()} className="defaultbtn" type="primary">Create New Address</button>
        <div
        ...
        >
            {addresses !== null ? <Table dataSource={addresses}>
                ...
                <Column
                    ...
                    key="id"
                    render={(dataIndex) => (
                        <button className="editbtn" type="round" onClick={()=>handleVisibleEditModal(dataIndex)}><EditOutlined/>Edit</button>
                    )}
                />
