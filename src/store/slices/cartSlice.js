...
export const cartSlice = createSlice({
    ...
    reducers: {
        addToCart: (state, action) => {
            let price = action.payload.couponDiscount && action.payload.couponDiscount.length!==0 ?action.payload.price - Math.round((action.payload.price*action.payload.couponDiscount[0].discount)/100 ):action.payload.price
            const addedItem = {
        ...
        addToCartQuantity: (state, action) => {
            console.log(action)
            let price = action.payload.product.couponDiscount && action.payload.product.couponDiscount.length!==0?
        (action.payload.product.price - Math.round((action.payload.product.price*action.payload.product.couponDiscount[0].discount)/100)) :
