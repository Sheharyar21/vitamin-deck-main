...
//     setIsModalVisible(false);
//   };
//   console.log("orderdata.props in order detail",orderData.props);
...
//                       Sold by <span className="l-blue">Vitamindeck</span>
//                     </p>
//                   </div>
//                 </div>
...
//                         </span>
//                           </Col>
//                           <Col xs={24} md={6} span={5}>{console.log(order)}

//                               {order.Variant.Product.reviews.length !== 0 ? (
//                                   <Rate
//                                       disabled={true}
//                                       defaultValue={order.Variant.Product.reviews[0].rating}
//                                   />) : [(orderReview !== 0 ? (
//                                   <Rate
//                                       disabled={true}
//                                       defaultValue={orderReview}
//                                   />) : <Link className="fs-14" onClick={() => showModal(order.Variant,order.id)} to="#">WRITE A REVIEW</Link>)]}

//                             {console.log("my-ratings",order.Variant.Product.reviews)}
//                           </Col>
//                         </Row>
//                       </div>
//                     </React.Fragment>))
...
function OrderDetailView(props) {
  ...
  return (
      orderData.length != 0 ?
          <div
              style={{ background: "#ececec" }}
              className="p-20 site-card-border-less-wrapper"
          >
            <div className="container">
              <div className="m-auto">
                <h4>Order Details</h4>
