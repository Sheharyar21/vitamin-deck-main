                            ...
                            props.cartItems.map((item) =>
                                <React.Fragment key={item.id.toString()}>
                                    <div className="cart-repeater p-2">
                                        ...
                                        <div className="cart-contents px-2">
                                        <span>
                                            <Link className="headerProductName"  style={{color:'#000'}} to={"/product/" + item.slug}
                                                  onClick={() => props.onClose()}>
                                                <WordLimit className="cart-product-name" limit={20}>{item.name}</WordLimit>
                                            </Link>
